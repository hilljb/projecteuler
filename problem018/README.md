...
This is a great problem, and can be solved very quickly when the solution is organized properly. For
details, see http://code.jasonbhill.com/python/project-euler-problem-18/
